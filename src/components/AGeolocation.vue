<template>
  ...
  <p v-if="loading">
    ...
    <span class="load-container ml-1" style="animation-delay: 0s">.</span>
    <span class="load-container ml-1" style="animation-delay: 0.2s">.</span>
    <span class="load-container ml-1" style="animation-delay: 0.4s">.</span>
